      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Somo gente dedikada a la compra y venta de corpiños.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold">Abel "El pingudo" Campana</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold">Pablo "Er diavl0" Rojas</h3>
              <p className="text-gray-600">Director de evasión de impuestos</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 rounded-full bg-gray-200 mx-auto mb-4 overflow-hidden">
                <img
              ...
              <h3 className="text-lg font-semibold">Canario Rodriguez</h3>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="flex items-center text-gray-600">
                  ...
                  Av. Belgrano Sur 1912, G4200 Santiago del Estero
                </p>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2 text-gray-600">
                ...
                <p>Domingos: Cerrado - hagase culia</p>
              </div>
            </div>
          </div>
        </motion.div>
