    ...
    <footer className="bg-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Masturcomerce</h3>
            <p className="text-gray-400">
              La tienda mas confiable (ojala) para comprar productos de masturbacion. Productos de calida, precio barato, wen servisio.
            </p>
          </div>
